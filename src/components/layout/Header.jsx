      ...
      <div className="container-fluid header-container">
        <div className="logo-container">
          <Link to="/" className="text-white text-decoration-none d-flex align-items-center">
            <img 
              src="/images/a-red-kangaroo-in-the-sturt-stony-desert-australia.webp" 
              alt="Рудий Кенгуру" 
              className="site-logo rounded-circle me-2"
            />
            <span className="fs-6">Сайт про Рудих Кенгуру</span>
          </Link>
        </div>
